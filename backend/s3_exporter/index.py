...
This script exports the contents of a DynamoDB table to S3 for a specified time period,
allowing for analysis of usage data.

Environment Variables:
- TABLE_ARN: The ARN of the DynamoDB table to export
- BUCKET_NAME: The name of the S3 bucket to export to
"""
...
def handler(event, context):
    """
    Lambda handler to export DynamoDB table to S3.

    This function exports the table contents for the last hour to S3.

    Args:
        event: The event data containing the execution time
