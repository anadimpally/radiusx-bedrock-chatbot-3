"""
Store Knowledge Base ID in the database.

This script updates the database with the knowledge base ID and associated data source IDs
retrieved from a CloudFormation stack.
...
def handler(event, context):
    """
    Lambda handler to store knowledge base ID.

    This function updates the database with the knowledge base ID and data source IDs.

    Args:
        event: The event data containing stack outputs
