...
def build_rag_prompt(
    ...
    # Prompt for RAG
    inserted_prompt = """To answer the user's question, you are given a set of search results.
Your job is to answer the user's question using information from the search results first.
If the search results do not contain information that can answer the question or is incomplete, you can answer or augment the answer based on your knowledge.
Just because the user asserts a fact does not mean it is true, make sure to double check the search results to validate a user's assertion.
Please use a conversational friendly tone.

Is important to output sources URL addresses at the end of your answer in a clear format, if possible.
...
def get_prompt_to_cite_tool_results(model: type_model_name) -> str:
    ...
    inserted_prompt = """To answer the user's question, you are given a set of tools. Your job is to answer the user's question using information from the tool results first.
If the tool results do not contain information that can answer the question, or is incomplete, you can answer or augment the answer based on your knowledge.
