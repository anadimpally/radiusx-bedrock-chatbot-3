import {
  SimpleMessage,
  RelatedDocument,
} from '../../../@types/conversation'; // Type definitions
import { AgentToolUse, AgentToolsProps } from '../xstates/agentThink'; // Type definitions

// Function to convert thinking log to agent tool properties
...
// Function to get related documents of a tool use
