...
/**
 * Button component for choosing files.
 *
 * @param {Props} props - The properties for the ButtonFileChoose component.
 * @returns {JSX.Element} The rendered ButtonFileChoose component.
 */
