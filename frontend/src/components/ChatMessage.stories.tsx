...
/**
 * Story for displaying a conversation with messages.
 */
...
/**
 * Story for displaying a conversation with a thinking message.
 */
...
/**
 * Story for displaying a conversation with an agent.
 */
