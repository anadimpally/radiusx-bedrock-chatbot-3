...
/**
 * Dialog component for confirming the deletion of an API key.
 *
 * @param {Props} props - The properties for the DialogConfirmDeleteApiKey component.
 * @returns {JSX.Element} The rendered DialogConfirmDeleteApiKey component.
 */
