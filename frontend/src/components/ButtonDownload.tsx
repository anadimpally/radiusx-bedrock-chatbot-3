...
/**
 * Button component for downloading text as a file.
 *
 * @param {Props} props - The properties for the ButtonDownload component.
 * @returns {JSX.Element} The rendered ButtonDownload component.
 */
