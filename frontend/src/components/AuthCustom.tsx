...
/**
 * Custom authentication component using AWS Amplify.
 *
 * @param {Props} props - The properties for the AuthCustom component.
 * @returns {JSX.Element} The rendered AuthCustom component.
 */
  ...
  return (
    <>
      {loading ? (
        ...
        // Pass the signOut function to the child components
