...
/**
 * Component for displaying and managing an API key item.
 *
 * @param {Props} props - The properties for the ApiKeyItem component.
 * @returns {JSX.Element} The rendered ApiKeyItem component.
 */
