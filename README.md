...
A SaaS architected RAG chatbot using LLM models provided by [Amazon Bedrock](https://aws.amazon.com/bedrock/) and AWS Knowledgebases for generative AI. Built and adapted for RadiusX.
